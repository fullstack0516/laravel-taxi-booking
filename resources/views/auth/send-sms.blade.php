            ...
            <div class="col-xl-5 offset-xl-3">
                <div class="login-register-page">
                    ...
                    @if($errors->any())
                        ...
                        @endforeach
                    @endif
                    <form method="post" action="{{ route('phoneverification.verify-phone') }}">
                        @csrf
                        <div class="input-with-icon-left">
                            <i class="icon-feather-phone"></i>
                            <input type="tel" class="input-text with-border" name="phone_number" id="emailaddress" placeholder="Phone Number" required autofocus/>
                        </div>
                        <button class="button full-width button-sliding-icon ripple-effect margin-top-10" type="submit">
                            Send Verification Code <i class="icon-material-outline-arrow-right-alt"></i>
                        </button>
                    </form>
                </div>
            </div>
