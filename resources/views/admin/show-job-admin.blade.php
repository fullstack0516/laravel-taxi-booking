...
{{--                                                        <div class="verified-badge"></div>--}}
                                                        <a href="{{ route('users.edit', ['user' => $bid->driver->id]) }}"><img @if($bid->driver->profile->avatar) src="{{ $bid->driver->profile->avatar }}" @else src="{{ asset('images/user-avatar-placeholder.png') }}" @endif alt=""></a>
                                                    </div>
                                                    <div class="freelancer-name">
                                                        <h4><a href="{{ route('users.edit', ['user' => $bid->driver->id]) }}">{{ $bid->driver->name }}</a></h4>
                                                        <div>@if($bid->driver->stripeAccount) <span class="badge badge-primary">Payment Verified</span> @endif @if($bid->driver->phone_verified_at) <span class="badge badge-secondary">Phone Verified</span> @endif @if($bid->driver->email_verified_at) <span class="badge badge-warning">Email Verified</span> @endif @if($bid->driver->approved_at) <span class="badge badge-info">Approved</span> @endif</div>
                                                        <div></div>
