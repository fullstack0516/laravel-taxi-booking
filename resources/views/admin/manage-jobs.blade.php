                                    ...
                                    @foreach($rides as $ride)
                                        <li>
                                            ...
                                            <div class="buttons-to-right always-visible">
                                                @if($ride->completed_at)
                                                    <a href="{{ route('rides.show', ['ride' => $ride->id]) }}" class="button ripple-effect"><i class="icon-material-outline-supervisor-account"></i> Leave Review</a>
                                                @else
                                                    ...
                                                    <a href="javascript:;" class="button remove gray ripple-effect ico" title="Remove" data-tippy-placement="top"><i class="icon-feather-trash-2"></i></a>
                                                    <form action="{{ route('rides.destroy', ['ride' => $ride->id]) }}" method="post">
                                                        @csrf
                                                        @method('DELETE')
                                                    </form>
                                                @endif
