...
use App\Http\Middleware\DriverIsApproved;
use App\Http\Middleware\SettingsCompleted;
...
class Kernel extends HttpKernel
{
    ...
    protected $routeMiddleware = [
        ...
        'settings_completed' => SettingsCompleted::class,
        'driver_approved' => DriverIsApproved::class,
